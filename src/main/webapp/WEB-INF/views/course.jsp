    ...
    <div class="navbar navbar-default navbar-fixed-top" role="navigation">
      <div class="container-fluid">
		...
		<ul class="nav navbar-nav">
                <li><a href="/myapp/home"><span class="glyphicon glyphicon-calendar"></span> ${us.name}</a></li>
                ...
                <div class="panel panel-default">
                    ...
                    <div id="onlineMentors" class="panel-collapse collapse">
						...
						<c:if test="${olm_user.size()==0}">No Online Users!</c:if>
							<c:forEach items="${olm_user}" var="olment">
                            <table class="table">
                                <tr>
                                    <td>
...
<div class="row">
	...
	<div class="col-md-3" style="max-height: 300px; overflow-y: auto;">
            <div class="panel-group" id="accordion">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion" href="#courseStudents"><span class="">
                            </span>Students</a>
                        </h4>
                    </div>
                    <div id="courseStudents" class="panel-collapse collapse in">
                        <div class="panel-body">
                            <table class="table">
							<c:if test="${ users.size()==0}">No Subscribed Users!</c:if>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion" href="#courseMentor"><span class="">
                            </span>Course Mentors</a>
                        </h4>
                    </div>
                    <div id="courseMentor" class="panel-collapse collapse">
                        <div class="panel-body">
						<c:if test="${m_user.size()==0}">No Subscribed Mentors!</c:if>
	...
	<div class="col-md-9"  style="max-height: 300px; overflow-y: auto;">
		<c:if test="${ topics.size()==0}">No Topics Under Course</c:if>
			<c:forEach items="${topics}" var="topic">
				<div class="col-md-12">
            		<div class="panel panel-primary">
                		...
                		<div class="panel-body" id="${topic.nodeId} ">
                		<c:if test="${topic.material.size()==0}">No Learning Objects</c:if>
                		<c:forEach items="${topic.getMaterial()}" var="leobj"><li><a id="${leobj.getNodeId()}" href="myapp/${thcourse.nodeId}/t/${topic.nodeId}/l/${leobj.getNodeId()}.learningObject">${leobj.name}</a></li>
                		</c:forEach>
                		</div>
            		</div>
        		</div>
...
$(document).ready(function () {
    ...
    $('.panel div.clickable').click();
  	...
  	function getTopics(crsId) {
  		
  			var url = "/myapp/ajaxHandlers/topics";
  			//var crsId=$('#courseNodeId').val();
  			$.ajax({
  			  type: "GET",
  			  url: url,
  			  data: "cid="+crsId,
  			  success: function(tpcs){
  				  alert(tpcs);
