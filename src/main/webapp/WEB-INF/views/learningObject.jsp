...
<link href="video-js/video-js.css" rel="stylesheet">
	...
	<style type="text/css">
	  ...
	  .vjs-default-skin .vjs-big-play-button { background: rgba(209,104,104,0.7) }
	  .vjs-default-skin .vjs-slider { background: rgba(209,104,104,0.2333333333333333) }
	</style>
	<script>
...
<!-- Modal -->
<!-- Modal --><div class="modal fade bs-modal-sm" id="myModal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    ...
    <div class="navbar navbar-default navbar-fixed-top" role="navigation">
      <div class="container-fluid">
		...
		<ul class="nav navbar-nav">
                <li><a href="#"><span class="glyphicon glyphicon-calendar"></span> ${us.getName()}</a></li>
...
<div class="col-sm-3 col-md-2 sidebar" style="height: 62%;position:fixed;">
		  ...
		  <div class="panel-group" id="accordion">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion" href="#onlineStudents"><span class="glyphicon glyphicon-folder-close">
                    ...
                    <div id="onlineStudents" class="panel-collapse collapse in">
                        <div class="panel-body">
                            <table class="table">
							<c:if test="users.size()==0">No Online Users!</c:if>
							<c:forEach items="${users}" var="user">
                                <tr>
                                    <td>
                                        <a href="/myapp/profile/${user.usrName}">${user.name}</a>
                                    </td>
                                </tr>
								</c:forEach>
                            </table>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion" href="#onlineMentors"><span class="glyphicon glyphicon-th">
                            </span>Online Mentors</a>
                        </h4>
                    </div>
                    <div id="onlineMentors" class="panel-collapse collapse">
                        <div class="panel-body">
						<c:if test="m_user.size()==0">No Online Users!</c:if>
							<c:forEach items="${m_user}" var="ment">
                            <table class="table">
                                <tr>
                                    <td>
                                        <a href="/myapp/profile/${ment.usrName}/">${ment.name}</span>
                                    </td>
                                </tr>
								</c:forEach>
                                </table>
...
<div id="maincontainer" >
    <div class="page-header text-center">
        <h1 id="timeline">${leobj.name}</h1>

<c:if test="${leotype=='VideoLeO'}"> 		
		<iframe src="${leofile}" width=40% height=40% style="border:1px solid black; margin: auto;"></iframe>
		</c:if>
		<c:if test="${leotype=='DocumentLeO'}">
		<iframe id="reader" src="${leofile}" width=40% height=40% style="border: none; margin: auto;"></iframe>
		</c:if>
    	...
    	<li>
          ...
          <div class="timeline-panel">
            ...
            <div class="timeline-footer">
                <a href="/myapp/${notify.leo.course.name}/t/${notify.leo.topic.name/l/${notify.leo.name.learningObject}}" class="pull-right">Continue</a>
            </div>
          </div>
        </li>
    </c:forEach>    
