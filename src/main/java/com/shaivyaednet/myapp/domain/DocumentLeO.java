...
public class DocumentLeO extends LearningObject{
	@RelatedTo(type="COMMENTS", direction=Direction.OUTGOING)
	public @Fetch Set<Comment> comments;
	private String filePath;
	public DocumentLeO(String ttle,Course crse,Topic tpc,User uId,int lvl,String fpth)
	{
		this.name=ttle;
		this.course=crse;
		this.topic=tpc;
